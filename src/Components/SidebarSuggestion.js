...
export default class SidebarSuggestion extends Component {
    render() {
        return (
                ...
                <View style={styles.noficationList}>
                    ...
                    <View style={styles.listMonth}>
                        <View style={styles.listHeader}>
                            <View>
                                <Image source={require("../Assets/image/buttonUp.png")}/>
                            </View>
                            <View>
                    ...
                    <View style={styles.listMonth}>
                        <View style={styles.listHeader}>
                            <View>
                                <Image source={require("../Assets/image/Icon-Shade.png")}/>
                            </View>
                            <View>
                                <Text style={{fontWeight: 'bold', fontSize: 15}}>۱ پروداکت ریلیز</Text>
                            </View>
