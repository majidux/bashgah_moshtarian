...
export default class MiddleBodyProductExpanded extends Component {
    render() {
        return (
                ...
                <View style={styles.middleBodyBox}>
                    ...
                    <View style={styles.footer}>
                        <View style={styles.subFooter}>
                            <Image
                                source={require('../Assets/image/productDetail.png')}
                            />
                            <Text style={styles.textFooter}>جزئیات محصول</Text>
                        </View>
                        <View style={styles.subFooter}>
                            <Image
                                source={require('../Assets/image/poll.png')}
                            />
                            <Text style={styles.textFooter}>نظر سنجی</Text></View>
                        <View style={styles.subFooter}>
                            <Image
                                source={require('../Assets/image/extendContract.png')}
                            />
                            <Text style={styles.textFooter}>تمدید قرارداد</Text></View>
                        <View style={styles.subFooter}>
                            <Image
                                source={require('../Assets/image/meetingDemand.png')}
                            />
