...
export default class DescribenewTicket extends Component {
    render() {
        return (
            <View style={styles.describeStyle}>
                ...
                <View style={styles.subHeader}>
                    <View style={styles.buttons}>
                        <View style={{paddingRight: 5}}>
                            <Image
                                source={require('../Assets/image/rotateLeft.png')}
                            />
                        </View>
                        <View style={{paddingLeft: 5}}>
                            <Image
                                source={require('../Assets/image/rotateRight.png')}
                            />
                        </View>
                    </View>
                    ...
                    <View style={styles.buttons}>
                        <Image
                            source={require('../Assets/image/B-icon.png')}
                        />
                    </View>
                    <View style={styles.buttons}>
                        <Image
                            source={require('../Assets/image/italic-I.png')}
                        />
                    </View>
                    <View style={styles.buttons}>
                        ...
                        <View style={{paddingHorizontal:4}}>
                            <Image
                                source={require('../Assets/image/lines2.png')}
                            />
                        </View>
                        <View style={{paddingHorizontal:4}}>
                            <Image
                                source={require('../Assets/image/lines3.png')}
                            />
                        </View>
                        <View style={{paddingHorizontal:4}}>
                            <Image
                                source={require('../Assets/image/lines4.png')}
                            />
                        </View>
                    </View>
                    <View style={styles.buttons}>
                        <View style={{paddingHorizontal:4}}>
                            <Image
                                source={require('../Assets/image/lines5.png')}
                            />
                        </View>
                        <View style={{paddingHorizontal:4}}>
                            <Image
                                source={require('../Assets/image/lines6.png')}
                            />
                        </View>
                        <View style={{paddingHorizontal:4}}>
                            <Image
                                source={require('../Assets/image/line7.png')}
                            />
                        </View>
                        <View style={{paddingHorizontal:4}}>
                            <Image
                                source={require('../Assets/image/line8.png')}
                            />
                        </View>
                    </View>
                </View>
                ...
                <View style={styles.footer}>
                    ...
                    <Image
                        source={require('../Assets/image/footerIcon.png')}
                    />
                </View>
            </View>
        );
